...
CREATE TABLE `Orders` (
    ...
    `status` ENUM('ORDER_RECIEVED', 'ORDER_PREPARED', 'ON_THE_WAY', 'DELIVERED') NOT NULL DEFAULT 'ORDER_RECIEVED',
    `payment_method` ENUM('CASH', 'ONLINE_BANKING') NOT NULL,
    `delivery_address` VARCHAR(191) NOT NULL,
    `is_paid` BOOLEAN NOT NULL,
    `imageTransaction` VARCHAR(191) NULL,
